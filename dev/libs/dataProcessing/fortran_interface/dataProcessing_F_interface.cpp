...
extern "C" {
    ...
    void electrons_write_double(
        const char* filename,
        const std::size_t num_kpoints,
        ...
        electrons::write(file, num_kpoints, num_bands, energiesVecor, occupationsVecor, overwrite);
    }
...
//        electrons::read(file, *num_kpoints, *num_bands, energyVec, occVec);
//
