 ...
 *          \f]
 */
const inline parameters::options_t peakOptions{"lorentz", "gauss"};
/// @brief Default width, unit is Hartree
const inline std::double_t defaultWidth{0.001};  // Hartree
/// @brief Default peak form
const inline std::string defaultPeak{"lorentz"};
...
class Peak : Node {
   public:
     ...
     * - "lorentz"
     */
    Option form{keys::FORM, peakOptions, defaultPeak};
