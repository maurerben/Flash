 ...
 *          that is defined by the sum of peak functions  \f$ f(\omega; \mu, \Delta) \f$ at the positions \f$ [E_1, E_2,
 * \hdots, E_n] \f$, weighted by the weights \f$ [w_1, w_2, \hdots, w_n] \f$ such that \f[ S(\omega) = \sum_{i=1}^n w_i
 * f(\omega; E_i, \Delta), \f] where \f$ \mu \f$ is the postion of the peak and \f$ \Delta \f$ its width.
 *
