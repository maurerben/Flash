...
class Config{
    ...
    public:
         ...
         */
        Config(const YAML::Node &configYamlFile, const std::vector<std::string> &allowedKeys = getAllowedKeys(), const std::vector<std::string> &mandatoryKeys = getMandatoryKeys(), const DefaultConfig &defaults = DefaultConfig());
        // Config(const YAML::Node &configYamlFile)
        //     : Config(configYamlFile, getAllowedKeys(), DefaultConfig()) {}
